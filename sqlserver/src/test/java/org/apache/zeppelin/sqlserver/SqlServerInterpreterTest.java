...
import static org.apache.zeppelin.sqlserver.SqlServerInterpreter.DEFAULT_JDBC_DRIVER_NAME;
import static org.apache.zeppelin.sqlserver.SqlServerInterpreter.DEFAULT_JDBC_URL;
import static org.apache.zeppelin.sqlserver.SqlServerInterpreter.DEFAULT_JDBC_USER_NAME;
import static org.apache.zeppelin.sqlserver.SqlServerInterpreter.DEFAULT_JDBC_USER_PASSWORD;
import static org.apache.zeppelin.sqlserver.SqlServerInterpreter.DEFAULT_MAX_RESULT;
import static org.apache.zeppelin.sqlserver.SqlServerInterpreter.SQLSERVER_SERVER_DRIVER_NAME;
import static org.apache.zeppelin.sqlserver.SqlServerInterpreter.SQLSERVER_SERVER_MAX_RESULT;
import static org.apache.zeppelin.sqlserver.SqlServerInterpreter.SQLSERVER_SERVER_PASSWORD;
import static org.apache.zeppelin.sqlserver.SqlServerInterpreter.SQLSERVER_SERVER_URL;
import static org.apache.zeppelin.sqlserver.SqlServerInterpreter.SQLSERVER_SERVER_USER;
 ...
 */
public class SqlServerInterpreterTest extends BasicJDBCTestCaseAdapter {

  private SqlServerInterpreter psqlInterpreter = null;
  ...
  public void beforeTest() {
    ...
    properties.put(SQLSERVER_SERVER_DRIVER_NAME, DEFAULT_JDBC_DRIVER_NAME);
    properties.put(SQLSERVER_SERVER_URL, DEFAULT_JDBC_URL);
    properties.put(SQLSERVER_SERVER_USER, DEFAULT_JDBC_USER_NAME);
    properties.put(SQLSERVER_SERVER_PASSWORD, DEFAULT_JDBC_USER_PASSWORD);
    properties.put(SQLSERVER_SERVER_MAX_RESULT, DEFAULT_MAX_RESULT);

    psqlInterpreter = spy(new SqlServerInterpreter(properties));
  ...
  public void testDefaultProperties() throws SQLException {
    ...
    SqlServerInterpreter psqlInterpreter = new SqlServerInterpreter(new Properties());

    assertEquals(DEFAULT_JDBC_DRIVER_NAME,
        psqlInterpreter.getProperty(SQLSERVER_SERVER_DRIVER_NAME));
    assertEquals(DEFAULT_JDBC_URL, psqlInterpreter.getProperty(SQLSERVER_SERVER_URL));
    assertEquals(DEFAULT_JDBC_USER_NAME, psqlInterpreter.getProperty(SQLSERVER_SERVER_USER));
    assertEquals(DEFAULT_JDBC_USER_PASSWORD,
        psqlInterpreter.getProperty(SQLSERVER_SERVER_PASSWORD));
    assertEquals(DEFAULT_MAX_RESULT, psqlInterpreter.getProperty(SQLSERVER_SERVER_MAX_RESULT));
  }

  @Test
  public void testConnectionClose() throws SQLException {

    SqlServerInterpreter psqlInterpreter = spy(new SqlServerInterpreter(new Properties()));
